...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactTypeIcon("MScCG1ZjX7FVkJwIo8N9rmn2dOcTgi3dqIgrAOMhqHwbHaZR9Z");
        contacttype.setContactType("qMBYKibDUrt6xlMFwiGPgZbAEVKbLjf7BMDm2MV6nNOHFRay18");
        contacttype.setContactTypeDesc("67MTF8bPjRGGAPSCjOTVQlqbZNVZV9e9B7KoAA6x1X1gPFctbv");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeIcon("LdU7W6E3aBRwCnYIZFWuSJS0AWUzE2tvlZM8BRg5my6dPG45eS");
            contacttype.setContactType("juilMVNwnrx73RZSg3EAxzddFrExJ63lshxfLbupDtU4nhJNyt");
            contacttype.setContactTypeDesc("GB3s4g8BKJtAqPCrjk8nTfIXFW0u9PQ2qwk4NPlheHXzH6EDz3");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "OyLKOVBdCVjVuFD5jR35qlDci4Uu2zusigS3wrdK3Dow3pPAfWmOeCXGf6eOErtZyY2HcLOCcjk1k8DQ1oT0SfxwJsfNqBHOlqHSUDXpU8vxPEcuzE5Qzqe2ScZfF5B52"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "o2rUcwpL9Kpn3uUJBOz8JUM5V1eLVBIpjed9BZ93T2yZE6nDkQ6TAFFQUruJyB3NVYJ3xLiFUDmtHMev4Pf5TtXemc407XXOy4lG2dQJZyO59owG0RL6Q1OKZ5n2iMByP"));
