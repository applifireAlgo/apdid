...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelIcon("Xqx29V8szbGm61Rc8XvcSSL5pQ8XBUZyVUeTPwdHcToTy5uYcY");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("1hfbQvoxtNkD189b20YAQ5yCQjbFHUFER8kWzZQfiQ4XJVepYO");
        useraccesslevel.setLevelName("gHBhTPZ5lPFWYqxnzwxUbvvnwDuW8LMVzdsbo70hra2I6REkft");
        useraccesslevel.setLevelDescription("JnGxzsif5L5hAV2EaMkRNxjyNGz2swOHqkjMctQymMxTyD3kTJ");
        ...
        useraccessdomain.setDomainDescription("v2jmlMZJDkXheSTCSlrvJEqrZs2m1VBEkbQjOBSXUzE9EsqxvN");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("pbBwwYduWIGDLfQGq45ZR3JiwpYpse18bBLkPvxfS3Cmgv20ZX");
        useraccessdomain.setDomainIcon("ct9UytX6UfXylimd1YWzqADYWo2BarG9geNSztkWXcFVGsqq1i");
        useraccessdomain.setDomainName("VgVEhHMFBvKI9gIkW2jsZHVE0G61intWJNAqcz4RBm27y2vpV0");
        ...
        User user = new User();
        user.setIsDeleted(1);
        user.setPasswordAlgo("jkQkL0EtYpnDAouAtbEURHo0NKMnBPb9FIEopkTTsnfjvSrYS2");
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setAllowMultipleLogin(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsLocked(1);
        user.setGenTempOneTimePassword(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1466582783419l));
        user.setSessionTimeout(1427);
        user.setMultiFactorAuthEnabled(1);
        user.setChangePasswordNextLogin(1);
        user.setUserAccessCode(5558);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1466582783419l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("9Pkc6TsRqsi6D4tJGteAwa7LTxrUdJvAkAd4TVu8KQiN6EOOo4");
        Question question = new Question();
        question.setQuestionIcon("Z5RG4LWw8SLgONrC0uRD5CeoqD5M9W6b44UE3bTEAqg5H4qTld");
        question.setLevelid(8);
        question.setQuestionDetails("49t2s4aa9L");
        question.setQuestion("Ze3lAWyLKWxEQKba9xX00NXblCzuc2CeJ2dFKQSApTgE5rNHyN");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("nYVoycl0SvMkyQyUBvgz82bv5pUqn874U8j1of4DyXQwPkGFGH");
        ...
        userdata.setOneTimePassword("4bX3o0xHcd1pMYwLjQLEg3WUTYXd1gBq");
        userdata.setPassword("6yxLhriehLnaMTZIzdvSnNfYAYGtyqZHhrSKhETG32mZHF8AbO");
        userdata.setLast5Passwords("b8SGqyo6i3g04YfXMHc3i2VN82itbmBLCJHyOzEausa8dIQJUy");
        userdata.setOneTimePasswordExpiry(2);
        userdata.setOneTimePassword("zLQavVIOMTlp3Wu49dEh2nKA56r1Sd8N");
        userdata.setPassword("D3IWLazPjmgITCp7WVA0q5oRwAbU0v4UXj53LA5euD6mX6u8z8");
        userdata.setLast5Passwords("7jvGt9Uevaa66zr179PVQR6u91m8kbkTF8OFnvRwKMcyRmSuty");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1466582783951l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 97064));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "WcSSwgFWcgSMD9jRN0CCQBbRy3rN4nW7eInlF1AzPFNqVgcevJRsCiAcUaoBNFggh"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5525));
