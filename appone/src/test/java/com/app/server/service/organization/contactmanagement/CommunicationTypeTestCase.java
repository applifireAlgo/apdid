...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("akP2EB7pXEEbifTUhOdwL3ZqpNx6rC2dQeFuVP3cdUIXaRmhhJ");
        communicationgroup.setCommGroupDescription("nUrUzFffEIQROf75RpVpbBmXAmVGffxTSJMjpA6EgqZqZVMNsQ");
        ...
        communicationtype.setCommTypeDescription("q6oUHa3yvOF6Ujxle1feLcdbps5tAfIpbuNAiJMLV0o46b8F0z");
        communicationtype.setCommTypeName("AWot2QOSDgpRuITIutixWomOX3VghQc6qzno1R8ipvS9xOqBnM");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeDescription("3ZL5w3QnRuTvIVkTsKfJ5q3d23RXgaFHlTEYAZf4oAEr4qQ7sa");
            communicationtype.setVersionId(1);
            communicationtype.setCommTypeName("wjZaLz3fFgcxQzWwSuXJuk8NoKJt3aEXJ4uDKcQ3lsgp4Avgm9");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "Uw7OvldcHeVTYHgVppMFnZgdvCk3dcqoAjrFKSJ3MVZlHj90fNRp6JggoiMmSlc5AaThrHxfpNabPko0DcQ9WAxtoFlOVP1C2Ra3yCHYgxuOUcnpmkNCJiM7av0ZsCj4f"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
