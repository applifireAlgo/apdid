...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("ZioujULOcbvBI2ASEY8T7PE16MG2aGmgGVIyhV69G9XEm4Cr4K");
        question.setLevelid(4);
        question.setQuestionDetails("vq2SSEyRFR");
        question.setQuestion("tPOQDHjNcgFoZO796rFAytn0kiMDpf8kh04TBI6voP62KEe94M");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("87kPwnQoBPOifnkdtUukPEJOhRn1ZEav73eBYpYYc5XlmaFECA");
            question.setLevelid(9);
            question.setVersionId(1);
            question.setQuestionDetails("eFr424tA0C");
            question.setQuestion("QgjiSc3KoERecmuAkJjWjNAesTImIrjAhNvrMTvuEGZhJ4i5Cg");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "Urf8Jypcs458nMFcxw36yZvvpv16u8BchFLZaTUzHzHU9P1uGVLtv3n8ygmFIblDF"));
